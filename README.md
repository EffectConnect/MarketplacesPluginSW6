...
> Warning: Only Shopware 6.6 is officially supported in this branch.<br><br>
> For Shopware 6.7 or higher support, use [releases](https://github.com/EffectConnect/MarketplacesPluginSW6/releases) with version 1.9 or higher.<br>
